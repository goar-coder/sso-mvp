...
class CustomOIDCBackend(OIDCAuthenticationBackend):
    ...
    def verify_claims(self, claims):
        # Por defecto mozilla_django_oidc requiere 'email'
        # Nuestros usuarios son externos (Django D1 via Keycloak SPI)
        # el userinfo solo garantiza 'sub' y 'preferred_username'
    ...
    def get_or_create_user(self, access_token, id_token, payload):
        ...
        if user and self.request:
            ...
            logger.error(f"=== ROLES EN SESIÓN === {app_roles}")
        return user